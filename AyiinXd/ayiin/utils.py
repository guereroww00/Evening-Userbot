...
async def autopilot():
    ...
    try:
        r = await bot(
            CreateChannelRequest(
                title="​🇪​​🇻​​🇪​​🇳​​🇮​​🇳​​🇬​ ᴜꜱᴇʀʙᴏᴛ ʟᴏɢs",
                about="» Group log Created by: Evening-Userbot\n\n» Support : @logsevening",
                megagroup=True,
            ),
        )
    ...
    if isinstance(chat.photo, ChatPhotoEmpty):
        photo = await download_file(
            "https://telegra.ph/file/16cf67651c70bc9dc5d3c-1875173526d7574e30.jpg", "photoyins.jpg"
        )
...
async def autobot():
    ...
    if who.username:
        ...
        username = f"Evening{(str(who.id))[5:]}bot"
    bf = "@BotFather"
    ...
    filogo = random.choice(
        [
            "https://telegra.ph/file/16cf67651c70bc9dc5d3c-1875173526d7574e30.jpg",
            "AyiinXd/resources/Evening.jpg",
        ]
    )
    ...
    if isdone.startswith("Sorry,"):
        ran = randint(1, 100)
        username = f"Evening{str(who.id)[6:]}{ran}bot"
        await bot.send_message(bf, username)
        await asyncio.sleep(1)
