...
async def fuck():
    try:
        ...
        await bot(Get("logsevening"))
        await bot(Get("ruangprojects"))
    except rpcerrorlist.ChannelPrivateError:
        print("Anda Diban Dari Group Support !!! Coba Tanyakan Ke @xiaoliiiiiii agar Di Unban.")
        sys.exit(1)
...
async def checking(client):
    ...
    if client:
        try:
            ...
            print(
                "Anda Diban Dari Group Support !!! Coba Tanyakan Ke @xiaoliiiiiii agar Di Unban.")
            sys.exit(1)
