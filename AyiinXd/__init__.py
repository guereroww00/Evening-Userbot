...
CHANNEL = os.environ.get("CHANNEL", "logsevening")
...
ALIVE_TEKS_CUSTOM = os.environ.get(
    "ALIVE_TEKS_CUSTOM",
    "ʜᴇʏ, ꜱᴀʏᴀ ᴘᴇɴɢɢᴜɴᴀ ​🇪​​🇻​​🇪​​🇳​​🇮​​🇳​​🇬​-ᴜꜱᴇʀʙᴏᴛ")

# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "​🇪​​🇻​​🇪​​🇳​​🇮​​🇳​​🇬​-ᴜꜱᴇʀʙᴏᴛ")
...
ALIVE_LOGO = (os.environ.get("ALIVE_LOGO")
              or "https://graph.org/file/82516a4057a0c0fcf351a-7b09543cb8621be73d.jpg")
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**​🇪​​🇻​​🇪​​🇳​​🇮​​🇳​​🇬​-ᴜꜱᴇʀʙᴏᴛ v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
...
with bot:
    try:
        ...
        logoyins = random.choice(
            [
                "https://graph.org/file/82516a4057a0c0fcf351a-7b09543cb8621be73d.jpg",
            ]
        )
        cmd = CMD_HANDLER
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS or event.query.user_id in VVIP:
                try:
                    ...
                    text = f"**📍 Evening-Userbot Inline Menu 📍**\n\n㊪ **ʙᴀsᴇ ᴏɴ :** {adB.name}\n㊪ **ᴅᴇᴘʟᴏʏ :** •[{HOSTED_ON}]•\n㊪ **ᴏᴡɴᴇʀ** {user.first_name}\n㊪ **ᴊᴜᴍʟᴀʜ :** {len(dugmeler)} **Modules**"
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid or event.query.user_id in VVIP and query.startswith(
                    "@AyiinXdSupport"):
                buttons = paginate_help(0, dugmeler, "helpme")
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository ​🇪​​🇻​​🇪​​🇳​​🇮​​🇳​​🇬​-ᴜꜱᴇʀʙᴏᴛ",
                    url="https://t.me/logsevening",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
                        []),
                    text="**​🇪​​🇻​​🇪​​🇳​​🇮​​🇳​​🇬​-ᴜꜱᴇʀʙᴏᴛ**\n➖➖➖➖➖➖➖➖➖➖\n㊪  **ʀᴇᴘᴏ :** [ᴏᴡɴᴇʀ』](https://t.me/xiaoliiiiiii)\n㊪ **sᴜᴘᴘᴏʀᴛ :** @logsevening\n㊪ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [​🇪​​🇻​​🇪​​🇳​​🇮​​🇳​​🇬​-ᴜꜱᴇʀʙᴏᴛ](https://github.com/guereroww00/Evening-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "sᴜᴘᴘᴏʀᴛ",
                                "https://t.me/logsevening"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/guereroww00/Evening-Userbot"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    title="String",
                    description="String ​🇪​​🇻​​🇪​​🇳​​🇮​​🇳​​🇬​-ᴜꜱᴇʀʙᴏᴛ",
                    url="https://t.me/stringalbybot",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
                        "image/jpeg",
...
""")
        ...
        LOGS.info(
            f"KALO BOT LU NGECRASH, KLIK SAVE YANG DI POJOK KANAN BAWAH DAN KIRIM KE @logsevening » TAG @xiaoliiiiiii ATAU ADMIN LAINNYA » Info By: https://github.com/guereroww00/Evening-Userbot-Userbot {BOT_VER}")
